...
public class CursoService {
    ...
    public CursoService(CursoRepository repository, ProfessorRepository professorRepository, AlunoRepository alunoRepository, CursoAlunoRepository cursoAlunoRepository) {
    ...
    public CursoAluno obterCursoAluno(Long idCurso,Long idAluno){
        ...
        var cursoAlunoId = new CursoAlunoID(aluno,curso);
        var alunoCursoNota = cursoAlunoRepository.findById(cursoAlunoId).orElseThrow(
